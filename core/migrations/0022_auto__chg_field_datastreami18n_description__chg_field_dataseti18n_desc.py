...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DatastreamI18n.description'
        db.alter_column('ao_datastream_i18n', 'description', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'DatasetI18n.description'
        db.alter_column('ao_dataset_i18n', 'description', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'VisualizationI18n.description'
        db.alter_column('ao_visualizations_i18n', 'description', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'DatastreamI18n.description'
        db.alter_column('ao_datastream_i18n', 'description', self.gf('django.db.models.fields.CharField')(max_length=140))

        # Changing field 'DatasetI18n.description'
        db.alter_column('ao_dataset_i18n', 'description', self.gf('django.db.models.fields.CharField')(max_length=140))

        # Changing field 'VisualizationI18n.description'
        db.alter_column('ao_visualizations_i18n', 'description', self.gf('django.db.models.fields.CharField')(max_length=140))
