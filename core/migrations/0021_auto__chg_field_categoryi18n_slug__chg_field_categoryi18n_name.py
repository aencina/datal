...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CategoryI18n.slug'
        db.alter_column('ao_categories_i18n', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=80))

        # Changing field 'CategoryI18n.name'
        db.alter_column('ao_categories_i18n', 'name', self.gf('django.db.models.fields.CharField')(max_length=80))

    def backwards(self, orm):

        # Changing field 'CategoryI18n.slug'
        db.alter_column('ao_categories_i18n', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=30))

        # Changing field 'CategoryI18n.name'
        db.alter_column('ao_categories_i18n', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))
