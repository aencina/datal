...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VisualizationParameter'
        db.create_table('ao_visualization_parameters', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('revision', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.VisualizationRevision'], null=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('default', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal(u'core', ['VisualizationParameter'])

        # Adding unique constraint on 'VisualizationParameter', fields ['revision', 'name']
        db.create_unique('ao_visualization_parameters', ['revision_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'VisualizationParameter', fields ['revision', 'name']
        db.delete_unique('ao_visualization_parameters', ['revision_id', 'name'])

        # Deleting model 'VisualizationParameter'
        db.delete_table('ao_visualization_parameters')
    ...
    models = {
        ...
        u'core.visualizationparameter': {
            'Meta': {'ordering': "['position']", 'unique_together': "(('revision', 'name'),)", 'object_name': 'VisualizationParameter', 'db_table': "'ao_visualization_parameters'"},
            'default': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'impl_details': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'position': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'revision': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.VisualizationRevision']", 'null': 'True'})
        },
